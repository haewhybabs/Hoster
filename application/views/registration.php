			...
			<div class="inner">
				<div class="container text-center">
					...
					<div class="b-authorization" >
						<form action="<?=base_url();?>Users/registration" method="POST" id="form-user">
                            ...
                            <div class="form-group">
	                            <label for="state">Your Street</label>
								<input type="text" name="street_add" id="street_add" /><br>
                            </div>
							...
							<div class="clearfix">
								<button class="custom-btn invers transparent" type="submit">Registration</button>
